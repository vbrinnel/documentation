...
Virtual Appliances are the fastest way to get started. However, since the Virtual Appliances are generally not suitable for use in production, users should plan to pick one of the other, more flexible installation methods for a production deployment.
